Solutions are made with the [advent-of-code-rust](https://github.com/fspoettel/advent-of-code-rust) template in mind which is why the code will look a bit shorter/weirder.  
